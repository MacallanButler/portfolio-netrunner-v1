...
export const metadata: Metadata = {
  title: {
    absolute: "About Macallan Butler | Full-Stack Developer & UI Architect",
  },
  description: "Learn about Macallan Butler, a full-stack developer and UI architect. Discover my tech stack, projects, and process.",
  alternates: {
    ...
    <div className="space-y-4 md:space-y-6 w-full py-2 md:py-4 min-h-[calc(100vh-4rem)] lg:min-h-[calc(100vh-10rem)] flex flex-col justify-between overflow-hidden">
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="max-w-[65ch] space-y-3.5 text-xs md:text-sm text-text-muted leading-relaxed font-sans">
          ...
          <p>
            You can usually find me at a coffee shop, splitting time between freelance work and full-time opportunities. Always looking for the next adventurous project — if your team needs help moving one forward, I&apos;m your guy.
          </p>
        </div>
      </div>
